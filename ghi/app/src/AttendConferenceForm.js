...
function AttendConferenceForm() {
    const [conferences, setConferencers] = useState([]);
          ...
          <div className="card shadow">
            <div className="card-body">
              <form onSubmit={handleSubmit} className={formClasses} id="create-attendee-form">
                ...
                <div className="mb-3">
                  <select onChange={handleConferenceChange} name="conference" id="conference" className={dropdownClasses} value={conference} required>
